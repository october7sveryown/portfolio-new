...
We'll be using following tech stack for this project:-
...
3. Grab API key from Groq's [Cloud console](https://console.groq.com/)
...
- Calls the LLM ```llama-3.1-70b-versatile``` using ```streamText``` function
...
Voila, you're done! See for yourself by trying it out and play around with it.
