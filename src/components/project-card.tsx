...
export function ProjectCard({
  ...
  return (
    ...
    >
      ...
      >
        {video && (
          <video
            ...
            muted
            playsInline
            className="pointer-events-none mx-auto h-48 sm:h-56 lg:h-48 w-full object-cover object-top"
          />
        )}
        {image && (
          <Image
            src={image}
            alt={title}
            className="h-48 sm:h-56 lg:h-48 w-full overflow-hidden object-cover object-top"
          />
        )}
      </Link>
      ...
      <CardContent className="mt-auto flex flex-col px-4 sm:px-6">
        {tags && tags.length > 0 && (
